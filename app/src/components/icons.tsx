export const WifiOffIcon = () => (
  <svg viewBox="0 0 24 24" fill="none">
    <path
      d="M3 3l18 18M9.5 16.5a3.5 3.5 0 014.9 0M5.5 12.8a9 9 0 0110-1.8M2 9a15 15 0 016-3.3m5 .3A15 15 0 0122 9"
      stroke="currentColor"
      strokeWidth="1.7"
      strokeLinecap="round"
